#|
Archivo: caratula.rkt
Descripción: define cada una de las listas de puntos que definen las letras de la caratula
...
;((draw-pixmap v1) "images/press-to-start.png" (make-posn 300 400))